...
**内容较多，推荐查询：**[HTTP_百度百科](https://baike.baidu.com/item/http/243074)
...
![图片无法显示](HTTP_image/image3.png)

URL由3个主要的部分构成：**协议**、**服务器地址**和**具体地址**

- **协议**：告诉我们面对的是何种类型的Internet资源。
