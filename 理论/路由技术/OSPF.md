...
![](attachment:8e8a95be-ace7-40da-8d21-5d306e06bbe2:image8.png)

![](attachment:de12b8d3-c0bc-41fc-a614-dd629f0eb6fd:image9.png)
...
![](attachment:a794ef9f-7257-4e9f-b5dd-5699b0946920:image10.png)

通过LSA序列号（sequenceNumber）对LSA进行接收确认。

一样，没啥可说的了，细看上文。

![image.png](attachment:86e8adf8-f712-4a88-9190-825730413fcf:image.png)
...
![](attachment:ff9acc0b-ab93-4816-8536-83c9d93c0df0:image12.jpeg)
...
![](attachment:1e1866a7-b741-409f-b40b-f09652b14712:image13.jpeg)

1. **收集LSA创建LSDB**（链路状态数据库、地图)
2. **使用SPF算法计算到每个目标网络的最短距离**
    
    ![](attachment:4b697312-5e47-4009-82e5-8348f61fd49a:image14.jpeg)
    
3. **生成路由**

![](attachment:3fe91077-ee20-4b2b-bae6-d1d6c83cabaf:image15.jpeg)
...
- MOSPF：（Multicast OSPF，组播扩展OSPF）， 是 OSPF 的早期组播扩展，定义于 RFC 1584，但在实际部署中逐渐被 PIM（协议无关组播） 取代，因为如果使用MOSPF就必须要求正4个网络中的单播路由都是OSPF的路由。https://baike.c114.com.cn/view.php?id=3832-D1993469&word=

> https://www.rfc-editor.org/rfc/rfc1585
> 
1. **External Attributes LSA（LSA 8）**
- 用途：用于传递类型5或类型7 LSA的外部度量和外部路由标签等属性信息。
- 内容：包含了关于外部路由的额外属性，如度量值和路由标签。
- 特点：这种LSA类型允许路由器在引入外部路由时，能够携带更多的路由属性信息，从而提供更丰富的路由选择依据。
1. **Opaque LSA（LSA 9、10、11）**
- 用途：用于在OSPF中扩展新的功能。
...
![文本 AI 生成的内容可能不正确。](attachment:18ac68a7-1897-42d7-99f4-8e536fe48bfb:image16.png)

LSA抓包

### LSA头部：

![image.png](attachment:80fbfc94-1ff5-4c80-b855-794ab24e8cf3:image.png)
...
![LSA1](attachment:508ac92b-661b-4c7e-a977-3a969eea1734:image17.png)

![image.png](attachment:1ca2b435-62a8-4dbd-be62-e696429f5a2d:image.png)
