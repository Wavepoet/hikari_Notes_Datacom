...
以下详见[**OSPF 4种末梢区域**](about:blank#ospf-4%E7%A7%8D%E6%9C%AB%E6%A2%A2%E5%8C%BA%E5%9F%9F)
...
![图示 描述已自动生成](attachment:d596a2ac-2353-498c-bb7e-2ec090ebe30c:image1.png)
...
![图示 描述已自动生成](attachment:18c04ad2-37c9-40f7-aa1c-0618539cbaf7:image2.png)
...
![image.png](attachment:5609888d-20ac-4151-a253-3351cbd57ab4:image.png)
...
- Hello、LSU、LSACK报文通过[组播](https://so.csdn.net/so/search?q=%E7%BB%84%E6%92%AD&spm=1001.2101.3001.7020)发送，DD与LSR通过单播发送。
- 默认Hello10秒，Dead30秒。
- 进行DR选举
- 邻居不需要手动指定
...
（DD或DBD） | **数据库描述包**，LSDB的包头（仅包含LSA头）用于确定已有和未有路由的路由，减少网络开销。 |
| Link Stata Request
(LSR) | **链路状态请求包**，请求[LSA](about:blank#lsa%E9%93%BE%E8%B7%AF%E7%8A%B6%E6%80%81%E9%80%9A%E5%91%8A)，OSPF邻居双方成功交换DD报文后才会向对方发出LSR报文，请求自己没有的LSA。 |
| Link Stata Update
（LSU） | **链路状态更新包**，回应LSR，向对端发送[LSA](about:blank#lsa%E9%93%BE%E8%B7%AF%E7%8A%B6%E6%80%81%E9%80%9A%E5%91%8A)。或泛红新的LSA。内容为多条LSA。 |
...
![image.png](attachment:53bc8996-7cbc-48ff-a1fe-60a2c39545be:image.png)
...
![image.png](attachment:53370ca4-5d19-4622-b5bd-602e5ca2b047:image.png)

![](attachment:28822acb-8188-49f0-9477-fcce8be801c0:image3.png)
...
![image.png](attachment:1643fddf-5607-4dd3-8c4b-6d857fb55459:image.png)

用于主从选举的报文（不包含LSA）：

![](attachment:c58fc6bf-4b0b-4d65-a773-9f59bef8c47b:image4.png)

用于描述LSA的报文：

![](attachment:f111f49b-9809-4d47-b110-8eebdfbf4eb6:image5.png)

- **Interface MTU：**

接口传输最大单元，用于描述接口的MTU值。在虚链路上，这个值通常为0。华为默认为0，不去检测。

关于MTU详见[TCP/IP传输层](file:///G:/TCP_IP/TCPIP_%E4%BC%A0%E8%BE%93%E5%B1%82%E5%8D%8F%E8%AE%AE.docx)，[TCP/IP网络层](file:///G:/TCP_IP/TCPIP_%E7%BD%91%E7%BB%9C%E5%B1%82%E5%8D%8F%E8%AE%AE.docx)。
...
![](attachment:059ef658-723c-4637-b52a-084c8f7ed255:image6.png)

### LSR数据包

![image.png](attachment:b61a0d8c-6c56-4139-92ed-0ee061c66a6f:image.png)

这辈子没见过这么好画的数据报

![](attachment:334d5a55-f7b6-4a93-b37e-074a47387de9:image7.png)
